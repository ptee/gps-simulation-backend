-- Tractor profile of 10 ton with avoidance of toll, motor, ferry
-- Info obtain from Markus@Kotte
...
function setup()
  return {
    properties = {
      max_speed_for_map_matching      = 70/3.6,  -- > m/s avg. about 60
    ...
    vehicle_length = 6.0, -- in meters, 4.8m is the length of large or family car
    vehicle_weight = 10000, -- car= 2 ton in kilograms
